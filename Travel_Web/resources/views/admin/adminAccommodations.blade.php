        ...
        <div class="container">
            <div class="row position-relative mb-4">
                ...
                <div class="position-absolute" style="right: 0;">
                    <button class="btn btn-dark custom-button d-flex align-items-center px-3 py-2" onclick="window.location.href='{{ route('addAccommodations') }}'">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    @foreach($accommodations as $acc)
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <button class="btn btn-primary" data-toggle="modal"
                                                data-target="#updateModal{{ $acc->id }}">
                        ...
                        <!-- Update Modal -->
                        <div class="modal fade" id="updateModal{{ $acc->id }}" tabindex="-1" role="dialog"
                             aria-labelledby="updateModalLabel{{ $acc->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="updateModalLabel{{ $acc->id }}">Update
                                            Accommodation</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('updateAccommodations', $acc->id) }}" method="POST"
